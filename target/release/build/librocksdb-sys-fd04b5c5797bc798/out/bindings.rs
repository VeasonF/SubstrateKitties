    ...
    pub fn rocksdb_writebatch_iterate(
        ...
        put: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                put: usize,
                deleted: *const libc::c_char,
                arg2: usize,
            ),
        >,
        deleted: ::std::option::Option<
            unsafe extern "C" fn(arg1: *mut libc::c_void, state: *const libc::c_char, put: usize),
        >,
    );
}
extern "C" {
...
extern "C" {
    pub fn rocksdb_writebatch_wi_iterate(
        ...
        >,
        deleted: ::std::option::Option<
            unsafe extern "C" fn(b: *mut libc::c_void, state: *const libc::c_char, put: usize),
        >,
    );
}
extern "C" {
...
extern "C" {
    pub fn rocksdb_compactionfilter_create(
        state: *mut libc::c_void,
        destructor: ::std::option::Option<unsafe extern "C" fn(state: *mut libc::c_void)>,
        filter: ::std::option::Option<
            unsafe extern "C" fn(
                state: *mut libc::c_void,
                destructor: libc::c_int,
        ...
        name: ::std::option::Option<
            unsafe extern "C" fn(state: *mut libc::c_void) -> *const libc::c_char,
        >,
...
extern "C" {
    pub fn rocksdb_compactionfilterfactory_create(
        ...
        create_compaction_filter: ::std::option::Option<
            unsafe extern "C" fn(
                state: *mut libc::c_void,
                destructor: *mut rocksdb_compactionfiltercontext_t,
            ) -> *mut rocksdb_compactionfilter_t,
        >,
        name: ::std::option::Option<
            unsafe extern "C" fn(state: *mut libc::c_void) -> *const libc::c_char,
...
extern "C" {
    pub fn rocksdb_filterpolicy_create(
        ...
        create_filter: ::std::option::Option<
            unsafe extern "C" fn(
                state: *mut libc::c_void,
                destructor: *const *const libc::c_char,
                create_filter: *const usize,
                key_may_match: libc::c_int,
                delete_filter: *mut usize,
            ) -> *mut libc::c_char,
        >,
        key_may_match: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                destructor: *const libc::c_char,
                create_filter: usize,
                key_may_match: *const libc::c_char,
                delete_filter: usize,
            ) -> libc::c_uchar,
        >,
    ...
    pub fn rocksdb_mergeoperator_create(
        ...
        full_merge: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                destructor: *const libc::c_char,
                full_merge: usize,
                partial_merge: *const libc::c_char,
                delete_value: usize,
                name: *const *const libc::c_char,
                arg1: *const usize,
                arg2: libc::c_int,
        ...
        partial_merge: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                destructor: *const libc::c_char,
                full_merge: usize,
                partial_merge: *const *const libc::c_char,
                delete_value: *const usize,
                name: libc::c_int,
